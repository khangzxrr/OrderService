...
namespace OrderService.Infrastructure.Migrations
{
    ...
    [Migration("20230602230951_MoveShipCostCostPerWeightToProduct")]
    partial class MoveShipCostCostPerWeightToProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderService.Core.ConfigurationAggregates.PriceTableConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("priceWeightDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("priceTableConfigurations");
                });
            ...
            modelBuilder.Entity("OrderService.Core.ProductIssueAggregate.IssueStateTracking", b =>
                {
                    ...
                    b.ToTable("IssueStateTracking");
                });

            modelBuilder.Entity("OrderService.Core.ProductIssueAggregate.ProductIssueShipping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductIssueShipping");
                });

            modelBuilder.Entity("OrderService.Core.ProductIssueRefundConfiguration.ProductIssueRefundConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderService.Core.ProductReturnAggregate.ProductIssue", b =>
                {
                    ...
                    b.Property<int?>("productIssueShippingId")
                        .HasColumnType("int");
                    ...
                    b.Property<float>("totalOrderDetailPrice")
                        .HasColumnType("real");
                    ...
                    b.HasIndex("productIssueShippingId");
            ...
            modelBuilder.Entity("OrderService.Core.ProductIssueAggregate.ProductIssueShipping", b =>
                {
                    b.HasOne("OrderService.Core.ShipperAggregate.Shipper", "shipper")
                        .WithMany("ProductIssueShippings")
                        .HasForeignKey("shipperId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OrderService.Core.ProductReturnAggregate.ProductIssue", b =>
                {
                    ...
                    b.HasOne("OrderService.Core.ProductIssueAggregate.ProductIssueShipping", "productIssueShipping")
                        .WithMany()
                        .HasForeignKey("productIssueShippingId");

                    b.Navigation("assignedEmployee");

                    b.Navigation("product");

                    b.Navigation("productIssueShipping");
                });
            ...
            modelBuilder.Entity("OrderService.Core.ProductReturnAggregate.ProductIssue", b =>
                {
                    ...
                    b.Navigation("issueStateTrackings");
                });
            ...
            modelBuilder.Entity("OrderService.Core.ShipperAggregate.Shipper", b =>
                {
                    ...
                    b.Navigation("ProductIssueShippings");
                });
